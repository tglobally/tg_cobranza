...
class controlador_cob_tipo_ingreso extends \gamboamartin\cobranza\controllers\controlador_cob_tipo_ingreso {
    ...
    public function __construct(PDO $link, stdClass $paths_conf = new stdClass()){
        ...
        $this->sidebar['lista']['titulo'] = "Tipos de Ingreso";
        $this->sidebar['lista']['menu'] = array(
            $this->menu_item(menu_item_titulo: "Alta", link: $this->link_alta,menu_seccion_active: true,
                menu_lateral_active: true));

        $this->sidebar['alta']['titulo'] = "Alta Tipo Ingreso";
        $this->sidebar['alta']['stepper_active'] = true;
        $this->sidebar['alta']['menu'] = array(
            $this->menu_item(menu_item_titulo: "Alta Tipo Ingreso", link: $this->link_alta,menu_lateral_active: true));

        $this->sidebar['modifica']['titulo'] = "Modifica Tipo Ingreso";
